...
Sequence-level characterization including GC content profiling (global and sliding window), trinucleotide k-mer frequencies, alignment-free similarity via cosine distance, and simple tandem repeat detection.
ML Gene Expression Prediction-

Supervised learning on promoter sequences- feature extraction (k-mers, GC content, regulatory motifs), model comparison across Ridge, ElasticNet, Random Forest, and Gradient Boosting, with permutation importance analysis.
